...
bool GameApp::InitResource()
{
	...
	VertexPosColor vertices[] =
	{
		...
		//上顶点
		{ XMFLOAT3(sqrt(3.0)/2.0f, 0.5f, 0.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },
		//右上顶点
		{ XMFLOAT3(-sqrt(3.0) / 2.0f, 0.5f, 0.0f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
		//右下顶点
		{ XMFLOAT3(sqrt(3.0) / 2.0f, -0.5f, 0.0f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
		//下顶点
		{ XMFLOAT3(-sqrt(3.0) / 2.0f, -0.5f, 0.0f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
		//左下顶点
		{ XMFLOAT3(0.0f, -1.0f, 0.0f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) }

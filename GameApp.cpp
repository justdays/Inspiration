...
bool GameApp::Init()
{
	...
	//初始化鼠标，键盘不需要，因为keyboard类内没有setwindow函数
...
void GameApp::UpdateScene(float dt)//屏幕更新函数
{


	/*屏幕移动速度设置*/
	static float phi = 0.0f, theta = 0.0f;//设置phi和theta数据
	//phi += 0.0001f, theta += 0.00015f;原来的位移速度
...
bool GameApp::InitResource()
{
	...
	//   |/______|/
	//  0       3
	VertexPosColor vertices[] =/*如果画成直角梯台，3.4.7要延长1个单位*/     /*正方体中心为原点，03方向时x轴，01方向时y轴，04方向是z轴*/
	{
		...
		{ XMFLOAT3(-1.0f, -1.0f, 2.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },//4
		{ XMFLOAT3(-1.0f, 1.0f, 1.0f), XMFLOAT4(1.0f, 0.0f, 1.0f, 1.0f) },//5
		{ XMFLOAT3(1.0f, 1.0f, 1.0f), XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f) },//6
		{ XMFLOAT3(2.0f, -1.0f, 2.0f), XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f) }//7
	};
	// 设置顶点缓冲区描述
